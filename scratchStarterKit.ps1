...
New-AzureRmDeployment `
  ...
  #from hub deployment
  {
    ...
    "dependsOn": [
        "[resourceId(parameters('ManResourceGroupName'),'Microsoft.Network/virtualNetworks/', parameters('ManvNetName'))]",
    ...
    "properties": {
        ...
        "remoteVirtualNetwork": {
            "id": "[resourceId(parameters('ManResourceGroupName'),'Microsoft.Network/virtualNetworks',parameters('ManvNetName'))]"
        }
    }
}
...
#from man deployment
{
  ...
  "name": "[concat(parameters('ManvNetName'), '/',variables('ManvNettoHubvNetPeeringName'))]",
  "location": "[resourceGroup().location]",
  "dependsOn": [
      "[concat('Microsoft.Network/virtualNetworks/', parameters('ManvNetName'))]",
      "[resourceId(parameters('HubResourceGroupName'),'Microsoft.Network/virtualNetworks/', parameters('HubvNetName'))]"
  ],
